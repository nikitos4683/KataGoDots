...
struct TrainingWriteBuffers {
  ...
  //C1: Legacy Go area difference target (such as due to seki). Always 0 for Dots; retained in the data format.
  //C2-3: Future board position a certain number of turns in the future. All 0 if C33 has weight 0.
  //C4: Legacy Go final board area/territory [-120,120]. Always 0 for Dots; retained in the data format.
