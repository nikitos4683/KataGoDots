...
BookParams BookParams::loadFromCfg(ConfigParser& cfg, int64_t maxVisits, int64_t maxVisitsForLeaves) {
  ...
  cfgParams.bonusForWLPV1 = cfg.getDoubleOrDefault("bonusForWLPV1", 0.0, 1000000.0, 0.0);
  cfgParams.bonusForWLPV2 = cfg.getDoubleOrDefault("bonusForWLPV2", 0.0, 1000000.0, 0.0);
  cfgParams.bonusForWLPVFinalProp = cfg.getDoubleOrDefault("bonusForWLPVFinalProp", 0.0, 1.0, 0.5);
  cfgParams.bonusForBiggestWLCost = cfg.getDoubleOrDefault("bonusForBiggestWLCost", 0.0, 1000000.0, 0.0);
  cfgParams.bonusBehindInVisitsScale = cfg.getDoubleOrDefault("bonusBehindInVisitsScale", 0.0, 1000000.0, 0.0);
  cfgParams.scoreLossCap = cfg.getDouble("scoreLossCap",0.0,1000000.0);
  cfgParams.earlyBookCostReductionFactor = cfg.getDoubleOrDefault("earlyBookCostReductionFactor", 0.0, 1.0, 0.0);
  cfgParams.earlyBookCostReductionLambda = cfg.getDoubleOrDefault("earlyBookCostReductionLambda", 0.0, 1.0, 0.5);
  ...
  cfgParams.adjustedVisitsWLScale = cfg.getDoubleOrDefault("adjustedVisitsWLScale", 0.0, 1000000.0, 0.05);
  cfgParams.maxVisitsForReExpansion = cfg.getDoubleOrDefault("maxVisitsForReExpansion", 0.0, 1e50, 0.0);
  cfgParams.visitsScale = cfg.getDoubleOrDefault("visitsScale", std::numeric_limits<double>::min(), std::numeric_limits<double>::max(), (double)(maxVisits + 1) / 2);
  cfgParams.visitsScaleLeaves = cfg.getDoubleOrDefault("visitsScaleLeaves", std::numeric_limits<double>::min(), std::numeric_limits<double>::max(), (double)maxVisitsForLeaves);
